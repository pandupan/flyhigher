...
export const RangeDateForm: React.FC<{
  ...
  setCloseDate: any
  data: any
}> = ({ type, openDate, closeDate, setOpenDate, setCloseDate, data }) => {
      ...
      >
        <Stack direction={"row"} spacing={1} alignItems={"center"}>
          <img
            ...
            style={imageStyle}
          />
          <span className="text-primary">{data?.name_user || "-"}</span>
        </Stack>
        <div>
          <Stack direction={"row"} spacing={1} alignItems={"center"}>
            ...
            <RatingService value={data?.rating_user} countReview={data?.total_reviewer_user} />
          </Stack>
        </div>
      </Stack>
...
const RatingService: React.FC<{ value: number; countReview: string }> = ({
  value,
  countReview = "0 Reviews",
}) => {
  return (
    <Stack direction={"row"} spacing={1} alignItems={"center"}>
